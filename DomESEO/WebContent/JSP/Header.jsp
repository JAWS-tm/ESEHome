...
<div id="profil_menu_popin" class="close">
	<c:if test="${ admin == 'oui' }">
		<button type="button" class="profil_menu_bouton" onclick="window.location.href ='Controleur?dest=pageAdmin'"><img class="profil_menu_bouton_icon" src="CSS/icone/admin.svg"></button>
	</c:if>
