...
<div id="header">
	...
	<div id="div_droite_header">
		<c:if test="${ connecte == 'oui' }">
			...
			<button id="profil_bouton"  type="button" onclick="toggle_profil_menu()">${ first_letter_user }</button>
			</div>
		</c:if>
		<c:if test="${ connecte != 'oui' }">
...
<div id="profil_menu_popin" class="close">
		<button type="button" class="profil_menu_bouton" onclick="window.location.href ='Controleur?dest=page_admin'"><img class="profil_menu_bouton_icon" src="CSS/icone/admin.svg"></button>
		<button type="button" class="profil_menu_bouton" onclick="window.location.href ='Controleur?dest=accueil'"><img class="profil_menu_bouton_icon" src="CSS/icone/dashboard.svg"></button>
		<button type="button" class="profil_menu_bouton" onclick="window.location.href ='Controleur?dest=modifUtil'"><img class="profil_menu_bouton_icon" src="CSS/icone/editer_profil.svg"></button>
...
<c:if test="${ is_error == 'oui' }">
	<div id="connexion_popin" style="display : flex;" class="index_50">
</c:if>
<c:if test="${ is_error != 'oui' }">
	<div id="connexion_popin" style="display : none;" class="index_50">
</c:if>
