...
class dBclass:
    ...
    def create_tables(self):
        ...
        self.cnx.commit()
        self.cursor.execute("INSERT INTO `object` (`physical_id`, `type_id`, `name`, `state`)VALUES ('00000000', 1, 'Station de base', 1),('00000001', 2, 'Lumière', 0),('00000002', 3, 'Lumière de nuit', 0),('00000003', 4, 'Prise', 0),('00000004', 5, 'Capteur de lumière', 0),('00000005', 6, 'Station météo', 0),('00000006', 7, 'Station météo exterieur', 1),('00000007', 8, 'Volet roulant', 0),('00000008', 9, 'Alarme', 0),('00000009', 10, 'Détecteur incendie', 1),('00000011', 12, 'Ventilateur', 0),('00000012', 13, 'GSM', 0),('00000013', 14, 'Détecteur de chute', 0),('00000014', 15, 'Détecteur de niveau d\'eau', 0),('00000015', 16, 'Capteur d\'air', 0),('00000016', 17, 'Tracker GPS', 0)")
        self.cnx.commit()
        #object_type
        self.cursor.execute("CREATE TABLE IF NOT EXISTS `object_type` (`id` int(11) NOT NULL AUTO_INCREMENT,`name` varchar(100) NOT NULL, PRIMARY KEY (`id`))")
        self.cnx.commit()
        self.cursor.excute("INSERT INTO `object_type` ('name') VALUES (`OBJECT_BASE_STATION`),(`OBJECT_SMART_LIGHT`),(`OBJECT_NIGHT_LIGHT`),(`OBJECT_SMART_SOCKET`),(`OBJECT_BRIGHTNESS_SENSOR`),(`OBJECT_STATION_METEO_INT`),(`OBJECT_OUT_WEATHER_STATION`),(`OBJECT_ROLLER_SHUTTER`),(`OBJECT_ALARM`),(`OBJECT_FIRE_DETECTOR`),(`OBJECT_WINE_DEGUSTATION`),(`OBJECT_VENTILATOR`),(`OBJECT_GSM`),(`OBJECT_FALL_SENSOR`),(`OBJECT_WATER_LEVEL_DETECTOR`),(`OBJECT_AIR_SENSOR`),(`OBJECT_TRACKER_GPS`),(`OBJECT_RFID`),(`OBJECT_LCD_SLIDER`),(`OBJECT_VOICE_CONTROL`),(`OBJECT_TOUCH_SCREEN`),(`OBJECT_E_PAPER`),(`OBJECT_MATRIX_LEDS`)")
        self.cnx.commit()
        #message
        ...
        self.cnx.commit()
        self.cursor.execute("INSERT INTO `message_type` (`name`, `hex_value`)VALUES ('RECENT_RESET', '02'),('ASK_FOR_SOFTWARE_RESET', '03'),('PING', '16'),('PONG', '06'),('EVENT_OCCURED', '30'),('PARAMETER_IS', '40'),('PARAMETER_ASK', '41'),('PARAMETER_WRITE', '42'),('I_HAVE_NO_SERVER_ID', 'FD'),('YOUR_SERVER_ID_IS', 'FE')")
        self.cnx.commit()
        #parameters
        self.cursor.execute("CREATE TABLE IF NOT EXISTS `parameters` (`id` int(11) NOT NULL AUTO_INCREMENT,`param_type_id` int(11) NOT NULL,`object_id` int(11) NOT NULL,`name` varchar(30) NOT NULL,`value` varchar(30) NOT NULL,`unit` varchar(30),PRIMARY KEY (id),FOREIGN KEY (param_type_id) REFERENCES param_types(id),FOREIGN KEY (object_id) REFERENCES object(id)")
        self.cnx.commit()
        self.cursor.execute("INSERT INTO `parameters` (`name`, `param_type_id`, `object_id`, `value`, `unit`)VALUES ('Température', 7, 6, '15', '°C'),('Mode', 15, 9, '15', NULL)")
        self.cnx.commit()
        #param_types
        self.cursor.execute("CREATE TABLE IF NOT EXISTS `param_types` (`id` int(11) NOT NULL AUTO_INCREMENT,`name` varchar(100) NOT NULL,`hex_value` varchar(2) NOT NULL,`interface_type_id` int(11),PRIMARY KEY (id),FOREIGN KEY (interface_type_id) REFERENCES interface_type(id)")
        self.cnx.commit()
        self.cursor.execute("INSERT INTO `param_types` (`name`, `hex_value`, `interface_type_id`) VALUES ('PARAM_UNKNOW', '00', NULL),('PARAM_MY_BASE_STATION_ID', '01', 2),('PARAM_ACTUATOR_STATE', '02', 3),('PARAM_SENSOR_VALUE', '03', 1),('PARAM_ALARM_TRESHOLD', '04', 1),('PARAM_ALARM_WAY', '05', 5),('PARAM_TEMPERATURE', '06', 2),('PARAM_HYGROMETRY', '07', 2),('PARAM_REFRESH_PERIOD', '08', 1),('PARAM_PRESSURE', '09', 2),('PARAM_BRIGHTNESS', '10', 4),('PARAM_WINDSPEED', '11', 2),('PARAM_PLUVIOMETRY', '12', 2),('PARAM_SCREEN_COLOR', '13', 6),('PARAM_MODE', '14', 5),('PARAM_DURATION', '19', 1),('PARAM_START_TIME', '16', 1),('PARAM_STOP_TIME', '17', 1),('PARAM_CURRENT_TIME', '18', 2),('PARAM_TRESHOLD', '19', 1),('PARAM_PM1_0', '20', NULL),('PARAM_PM2_5', '21', NULL),('PARAM_PM10', '22', NULL),('PARAM_TEXT_PART0', '64', NULL),('PARAM_TEXT_PART1', '65', NULL),('PARAM_TEXT_PART2', '66', NULL),('PARAM_TEXT_PART3', '67', NULL),('PARAM_TEXT_PART4', '68', NULL),('PARAM_TEXT_PART5', '69', NULL),('PARAM_TEXT_PART6', '70', NULL),('PARAM_TEXT_PART7', '71', NULL)")
        self.cnx.commit()
