...
//Portage...
#define GPIO_SET_OUTPUT(pin)		GPIO_configure(pin, GPIO_PIN_CNF_PULL_Pullup, true)
#define GPIO_SET_INPUT(pin)			GPIO_configure(pin, GPIO_PIN_CNF_PULL_Pullup, false)
