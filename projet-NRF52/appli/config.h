...
//Config propres � chaque objets.
		...
		#define PIN_UART_TX	8		//pour ne pas faire comme tout le monde (et r�soudre un pb hardware !)
		#define PIN_UART_RX	6		//pour ne pas faire comme tout le monde (et r�soudre un pb hardware !)
	#endif
